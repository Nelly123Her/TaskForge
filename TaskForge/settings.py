...
# Ensure Django can find apps inside the "apps/" folder
...
SECRET_KEY = 'django-insecure-&ljncj!6@qkvna)itp6@!_s-ln7n6*!h2*!7@=%_#=_#yf(+)j'
...
INSTALLED_APPS = [
    ...
    'api',
    'user_auth',  # Ensure this matches your app name
